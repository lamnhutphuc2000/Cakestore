 ...
 * @author ASUS
 */
@WebServlet(name = "ShowActiveUserServlet", urlPatterns = {"/ShowActiveUserServlet"})
public class ShowActiveUserServlet extends HttpServlet {

    private final String SHOW_ACTIVE_USER = "showActiveUserPage";
            ...
            if (session != null) {
                ...
                if (user != null) {
                    ...
                    if (user.getRoleID().equals(roleIDOfAdmin)) {
                        ...
                        dao.getActiveUser();
                        List<UserDTO> listUsers = dao.getListUsers();
                        request.setAttribute("listUser", listUsers); 
                        url = resourceBundle.getString(SHOW_ACTIVE_USER);
                    }
                }
            } 
